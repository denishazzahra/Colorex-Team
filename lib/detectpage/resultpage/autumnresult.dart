...
class MyAutumnResultPage extends StatelessWidget {
  const MyAutumnResultPage({super.key});
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              Row(
                                children:
                                    createColors(autumnPalette1.sublist(0, 5)),
                              ),
                              Row(
                                children:
                                    createColors(autumnPalette1.sublist(5, 10)),
                              ),
                              const SizedBox(
                                height: 24,
                              ),
                                  ...
                                  Expanded(
                                    child: RichText(
                                      ...
                                      text: const TextSpan(
                                        ...
                                        children: <TextSpan>[
                                          TextSpan(
                                            text: 'Kamu tuh cocok sama warna ',
                                          ),
                                          TextSpan(
                                            text: 'Auntumn',
                                            style: TextStyle(
                                          ...
                                          TextSpan(
                                            text:
                                                '. Kalau kamu liat ke cermin, yang pertama kali kamu notice itu kehangatan yang keluar dari setiap detail wajah kamu. Kulit, rambut, dan mata kamu semuanya punya warna dasar yang mirip emas gitu.',
                                          ),
                                          TextSpan(
                                            text: "\n\n\n",
                                          ),
                                          TextSpan(
                                            text:
                                                'Terus, warna kamu tuh lembut dan agak suram, gak terlalu terang dan jelas banget. Jadi, bukannya bertabrakan, fitur-fitur kamu lebih kayak nyatu gitu. Karena warnanya agak lemah, penampilan kamu terkesan santai dan tenang. Jadi, kesannya kontrasnya pas di tengah-tengah aja antar fitur-fitur kamu.',
                                          ),
                                        ],
                                      ),
                                    ),
